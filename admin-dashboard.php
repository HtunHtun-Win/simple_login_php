                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="role" class="form-control">
                                                    ...
                                                    <option value="admin" <?php if ($userInfo['role'] == 'admin') : ?> selected <?php endif; ?>>
                                                        Admin
                                                    </option>
                                                    <option value="user" <?php if ($userInfo['role'] == 'user') : ?> selected <?php endif; ?>>
                                                        User
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <?php foreach ($users as $user) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else : ?>
                                                    <a href="_actions/delete.php?id=<?= $user['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete is user?')">
                                                        Delete
                                                    </a>
                                                <?php endif ?>
                                            </td>
